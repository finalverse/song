...
public:
    ...
    virtual muse::Ret storeSecret(const std::string& providerId, const std::string& credentialName, const std::string& secret) = 0;
    virtual muse::RetVal<std::string> loadSecret(const std::string& providerId, const std::string& credentialName) const = 0;
