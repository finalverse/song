...
public:
    SvgPaintEnginePrivate()
    {
        ...
        attributes.title = QLatin1String("Finalverse Song Studio SVG Document");
        attributes.description = QString("Generated by Finalverse Song Studio %1").arg(application()->version().toString());
// UNUSED
