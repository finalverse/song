@echo off
ECHO "Finalverse Song Studio package"
...
IF %BUILD_MODE% == nightly ( 
    SET ARTIFACT_NAME=Finalverse-Song-Studio-Nightly-%BUILD_NUMBER%-%BUILD_BRANCH%-%BUILD_REVISION%-%TARGET_PROCESSOR_ARCH%
) ELSE (
    SET ARTIFACT_NAME=Finalverse-Song-Studio-%BUILD_VERSION%-%TARGET_PROCESSOR_ARCH%
)
...
IF %BUILD_MODE% == nightly ( 
    SET ARTIFACT_NAME=Finalverse-Song-Studio-Nightly-%BUILD_NUMBER%-%BUILD_BRANCH%-%BUILD_REVISION%-%TARGET_PROCESSOR_ARCH%.msi
) ELSE (
    SET ARTIFACT_NAME=Finalverse-Song-Studio-%BUILD_VERSION%-%TARGET_PROCESSOR_ARCH%.msi
)
...
IF %BUILD_MODE% == nightly ( 
    SET ARTIFACT_NAME=Finalverse-Song-Studio-Nightly-%BUILD_NUMBER%-%BUILD_BRANCH%-%BUILD_REVISION%-%TARGET_PROCESSOR_ARCH%.paf.exe
) ELSE (
    SET ARTIFACT_NAME=Finalverse-Song-Studio-%BUILD_VERSION%-%TARGET_PROCESSOR_ARCH%.paf.exe
)
